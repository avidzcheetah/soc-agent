...
*Note: Following EXP_002E's negative results, we are rolling back to the **EXP_20260713_001** model checkpoint as the final, locked Phase 1 classifier (Macro F1 0.730). The SecBERT encoder will now be frozen and development will move to the PPO agent phase. (Architecture Locked)*
