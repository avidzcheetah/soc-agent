...
| **EXP_002D** | `EXP_20260713_001` | **Targeted Synthetic Augmentation.** Base = EXP_002C. Synthetically enrich the 4 weakest classes (`block_port`, `restore_registry`, `restore_defense_config`, `snapshot_forensics`) by 40-60 samples. | ✅ Macro F1: 0.730 (+0.024). Top-2 Acc: 0.968. Completed Architecture Lock. |

*Note: After EXP_002D, the SecBERT encoder will be frozen and development will move to the PPO agent phase. (Completed)*
